...
```{r}
here::i_am("0.5_Genotypic_Analysis.Rmd")
```
...
# write.csv(table2, here("data","Final_Files","Markers_per_Chrom_Summary.csv"), row.names = FALSE)
...
# Export as pdf : ~/output/Figures/Markers_per_Chromosome2.pdf
...
# write.csv(sum_tab, here("data","Final_Files","Markers_Summary.csv"), row.names = TRUE)
