...
Heritability estiamte from Bajgain et al 2025 (https://onlinelibrary.wiley.com/doi/abs/10.1002/csc2.70126):
$$H^2 = \frac{σ_g^2 }{(σ_g^2 + \frac{σ_{gl}^2}{l} + \frac{σ_{gy}^2}{y} + \frac{σ_e^2}{ly})}$$

where σg2 is the genetic variance, σgl2 is the genotype × location variance, σgy2 is the genotype × year variance, σe2 is the residual variance, l is the number of locations, and y is the number of years. Variance components used to estimate H2 were obtained by fitting a linear model using the aov function in R.
...
####### H2 (C07 + C10) has no residual error varience !!! #########
